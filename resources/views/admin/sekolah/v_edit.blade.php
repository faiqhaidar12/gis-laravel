                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="alamat" value="{{ $sekolah->alamat }}" class="form-control"
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input name="posisi" value="{{ $sekolah->posisi }}" id="posisi" class="form-control"
                                    placeholder="Posisi Sekolah">
                                <div class="text-danger">
                                    @error('posisi')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" class="form-control" placeholder="Deskripsi"
                                    rows="5">{{ $sekolah->deskripsi }}</textarea>
                                <div class="text-danger">
                                    @error('deskripsi')
                                        {{ $message }}
                                    @enderror
